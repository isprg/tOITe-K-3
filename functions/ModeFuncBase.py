...
def createDictProc():
	dictProc = {
		...
		"GO_TO_TUTORIAL"	: go_to_tutorial_ModeProc,
	}
	return dictProc
...
def createDictWindow():
	...
	layoutGo_To_Tutorial = make_fullimage_layout("png/ending.png", "GO_TO_TUTORIAL")
	...
	dictLayout = {
		...
		"GO_TO_TUTORIAL": layoutGo_To_Tutorial,
...
# go_to_tutorialモード処理 ======================================================
def go_to_tutorial_ModeProc(dictArgument):
